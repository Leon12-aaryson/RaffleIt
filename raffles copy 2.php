    ...
    <div class="con p-3 raffle">
        ...
        <div class="row  g-3">
            <?php foreach ($raffles as $samp) : ?>
                <div class="col-md-4 raffle" id="card<?php echo $samp->id; ?>" onclick="showCardDetails('card1')">
                    <div class="card p-2 custom-card-raffle">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="<?php echo $samp->picture; ?>" class="card-img-left" alt="Image">
                                </div>
                                <div class="col-md-5">
                                    <div class="card-body">
                                        <h5 class="card-title fw-bold muted"><?php echo $samp->reason; ?></h5>
                                        <h6 class="card-subtitle fw-normal"><?php echo $samp->reason; ?></h6>
                                        <h6 class="card-subtitle muted fw-normal"><?php echo $samp->reason; ?></h6>
                                        <!-- <p class="card-text"><i class='bx bx-time'></i> 20h 33m</p> -->
                                    </div>
                                    <div class="row testimon">
                                        <p class="card-text"><i class='bx bx-stopwatch'></i><?php echo $samp->enddate; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-3">
